...
%	\vfill
	...
	\textbf{Quirk - Indomitable:} Once per session, negate an inflicted status-effect (except Crippled) from yourself or your ally.
...
%	\vfill
	...
	\textbf{Associated skills:} Science, Melee, Medicine, Lockpick
	
	\medskip
	
	You have left the safety of your underground shelter - either voluntarily or not - and now must brave the Wasteland and its horrors with the help of some durable Stable-Tec equipment.	
	
	\textbf{This P.A.S.T. is subject to GM approval.}
	
	\textbf{Quirk - Stable Tech:} You start the game with \emph{Pip-Buck training} -perk for free.
	...
	\subsection*{Steel Ranger}
	\textbf{Associated skills:} Firearms, Mechanics, Intimidation, Explosive
	
	\medskip
	
	Having been part of the well-armed faction of Steel Rangers, you have gotten used to wearing heavier armors.	
	
	\textbf{This P.A.S.T. is subject to GM approval.}
	
	\textbf{Quirk - Ranger Schooling:} You start the game with \emph{Tank Horse} -perk for free.
...
%	\vfill
	...
	\textbf{Associated skills:} Barter, Survival, Unarmed, Sleight
	
	\medskip
	
	Contracts and caps - they are your forte for having been part of one of the notorious griffin mercenary groups in the Wasteland, the Talons. As such, you have picked some tricks from the best.
	
	\textbf{This P.A.S.T. is subject to GM approval.}
	
	\textbf{Quirk - Talon Guarantee:} You start the game with \emph{Bounty Hunter} -perk for free.
...
%	\vfill
	...
	\subsection*{Pink in the Blood}
	\emph{\textbf{Earth Pony-only trait.}}
	
	You are just a little bit more magical than your kin, much like the Ministry Mare Pinkie Pie. How, you ask? Who knows! Don?t look now, but I think she?s staring at you.
	
	You have access to \textbf{Enchantment and Conjuration Unicorn magic schools} in addition to your Earth Pony Magic. As a downside, your mind is a little bit more frail than that of your kin; -1 END to resist mind-altering status effects (Dazed, Enraged and Mind-Controlled and you have a 35 \% chance of accumulating Insanity instead of 25 \%.
	...
	The GM determines what is considered a small or large community.
		...
		\begin{table*}[!htbp]
		\begin{talltblr}[
			caption={Spirit Specific Effects of Spirit Child -trait},
			entry=none
			]
			{				
				colspec = {|l|X[l,3]|X[l,1]|X[l,1]|X[l,1]|},
				row{odd} = {gray!30}, row{even} = {gray!10},
				rowhead = 1
			}
			\hline
			\textbf{Spirit} & \textbf{Buff}                                                                       & \textbf{Immunity} & \textbf{Skill} & \textbf{Penalty}       &  \\ \hline
			Embers		& Non-Magic attacks are considered to deal Fire damage								  & Burning			  & +10 Intimidation     & -1 END vs Freezing \\
			Machines    & When within a Small Splash Radius of you, allies have a +5 Crit chance for 3 rounds & Stunned           & +10 Mechanics        & -5\% Poison Resistance &  \\
			Nature		& When within a Small Splash Radius of you, allies recover +1 HP per turn for 3 rounds & Poisons (except Taint \& Pink Cloud) & +10 Survival & -1 END vs Stunned \\
			Serenity	& Non-Magic attacks are considered to deal Electricity damage						  & Dazed			  & +10 Medicine		& -1 END vs Bleeding \\
			Shadows		& You are surrounded by a Small Splash area of darkness, giving enemies -15 to hit you for 3 rounds of combat. & Bleeding 		& +10 Sneak & -1 END vs Dazed \\
			Streams 	& Non-Magic attacks are considered to deal Cold damage									& Freezing 		& +10 Science			& -1 END vs Burning \\
			Trust		& When within a Small Splash Radius of you, allies have +1 DT for 3 rounds				& Mind-Controlled & +10 Diplomacy 		& -1 END vs Blinded \\
			Whispers	& Non-Magic attacks can cause Enraged-status effect										& Blinded		& +10 Sleight			& -1 END vs Mind-Controlled \\
			Chaos		& When within a Small Splash Radius of you, enemies suffer a +5 to their Crit Failure chance. & Enraged & +10 Barter 			& -1 END vs Petrified \\
			\hline
		\end{talltblr}		
	\end{table*}
	
	\subsection*{Spirit Child}
	\emph{\textbf{Zebra-only trait.}}
	
	You're something of an anomaly, even among your fellow Zebra. You are kin to a spirit, and you have an unusual and strange air about you because of it. Ancient ritual of marrying a mortal mare or stallion to a spirit has resulted well... in you. 
	
	You gain access to a special form that you can slip into at will, gaining bonuses and penalties while under its effect. You can maintain the form for CHA number of rounds safely. Each turn afterwards requires an Insanity roll as the form begins to shake your mental fortitude. 
	
	When in this form, you resemble the spirit you originate from, with otherworldly qualities such as being wrought in flame, having your skin ripple like waves and so on. The effect itself can be determined by the player in question, but even the most benign transformation is upsetting and alarming to creatures around the character.
	
	You can choose any of the Spirits listed in Table 2.4. You gain spells of your chosen Spirit as you level-up, and different bonuses and penalties when slipping into the special form as detailed on the table. The list of spells can be found under Chapter 8: Magic \& Spells - Zebra Magic - Shamanism.
	
	
	\textbf{Universal Form effects:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item Gain access to spirit's Spells depending on your level; Start with 2 Spells from their list, gain 2 every 4th lvl*
		\item +1 DT against non-magical dmg
	\end{compactitem}
	\textit{*Spirit of Chaos rolls 1d8 to select a Spirit where their spells come from, then rolls another 1d8 to determine the spell they get. Duplicate spells are rerolled.}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item Distraction from transformation affects all in Large Splash area
		\item AP cost for non-magic attacks is increased by 2
		\item -1 DT against Magical dmg
		\item -2 max HP
	\end{compactitem}
...
%	\vfill
	...
	\textbf{This Trait cannot be taken alongside Spirit in the Flesh. Taking this trait doesn't require Spiritually Awakened or Tribal Shaman.}
	
	\pagebreak
	
	\subsection*{Spirit in the Flesh}
	\emph{\textbf{Zebra-only trait.}}
	
	From an early age you have had something inhabit your body, whispering things to you and guiding -in either good or ill intent- you. The circumstances of your union can vary; maybe you found it weak and gave it shelter, maybe the vagabond spirit bound itself to you upon your birth. The spirit can be of any Karma, including the opposite of your own.
	
	Having a lesser spirit or a spirit of the dead coexist with you has given you something unique however, aside from having a companion in your head that only you can hear. Your Melee and Unarmed attacks are always magical in nature and when taking damage, you can convert half of the damage (rounded down) into Strain damage instead for as long as you have Strain available. A minimum of 1 damage has to go to your HP when dividing the damage.
	
	Spirits are likely to show themselves to you, and with a successful PER -1 roll, you can see spirits that try to hide from you.
	
	As a downside, your spiritual coexistence has made your body somewhat weaker; your Natural Healing goes down by one, to a minimum of 1 and you never managed to learn Alchemy.
	
	Shamans and spirit-sensitive creatures can see your otherworldly passenger, while to most creatures it is invisible. It will tempt you to do deeds of its Karma -Positive karma will urge you to help other creatures, while negative karma urges you to be selfish-, which you can resist with an opposed CHA roll. Both you and the Spirit use your CHA as the stat for the Opposed roll.
	
	\textbf{Cannot be taken simultaneously with Spirit Child. Taking this trait doesn't require Spiritually Awakened or Tribal Shaman.}
	...
	Characters that want to use Power Armor without these cruel penalties must gain the training, and \textbf{Power Armor Training} -reward perk or get chummy with a suitable faction in-story.
	...
	The adventurer now has weapons and armor to face the odds of the Wasteland. However, she also might wish to have utilities to help her through the journey.  Such utilities are backpacks to hold her gear in, such as food, medicine and anything she comes upon traveling. \textbf{PCs start with a Saddle-bag.}
...
%	When weapons suffer a condition drop, they begin to lose in their ability to deal damage by changing the dice you roll to calculate damage. Likewise, the gun's value drops with each level of wear and tear it has. 
	...
	When weapons suffer a condition drop, their effectiveness starts to suffer, increasing the AP cost of attacking with said weapon. Likewise, the weapon's value drops with each level of wear and tear it has.
...
%	At Heavily used and Poor, the weapons' critical modifiers also lower, meaning that a badly damaged gun is less likely to do damage excellently.
	...
	Your character gains experience points for accomplishing goals, killing things, cunning plans or just about anything that the GM feels would merit it. Your character gains a level when she reaches the associated experience total. How your GM gives experience points depends on the GM's preference; some give EXP at the end of the session, while others may give experience at certain points in the story. 
	...
	Your character gains a \textbf{perk} every time she gains a level. Perks are beneficial bonuses to the character, and a measure of the character's growth. Unlike Traits which have both pros and cons to them, perks are positive qualities your character has learned over their adventure.
	
	Perks also have levels associated with them, indicating the earliest level the character must be for the perk to be available to them. A level 2 perk is open to characters at level 2 and onward. Level 12 perks are available at level 12 and further. Players can choose any perks from any levels they've already cleared, as long as they meet requirements. For example, a 10th level PC can take perks from level 2 to 10 as long as they fill the requirements.
	
	There are a great deal of perks available in \emph{Wasteland Ventures}. Perks have requirements which must be met before taking the perk, often either a SPECIAL or Skill requirement. Temporary penalties do not limit a character's available perks, but temporary buffs do not allow one to take a perk she could otherwise not take.
	...
	While leveling up and getting perks are the most common, most available way for character growth, there are other ways PCs can improve their SPECIALs, skills and attributes. Some items, such as alcohol, food or clothing give temporary bonuses, and have been explained in the previous chapter. 
	
	Permanent bonuses come from much rarer sources; Ministry Mare statuettes, Cybernetic implanting, Alchemical Enhancements and Pre-War books.
%	Your character can also improve her SPECIALs, skills and other attributes through bonuses gained by items. Most bonuses are temporary, either lasting a pre-set duration - such as bonuses from drugs - or only while your character is actively using the item, such as bonuses from clothing. However, there are a few items in the Equestrian Wasteland which can be used for permanent character improvement, such as the Ministry Mare Statuettes.
	...
	Cybernetic limbs and implant can grant a permanent bonus to a character, but clinics capable of performing cybersurgery are extremely rare and expensive. One cannot have two of same implants, as this will cause conflicts between them. Attachement of cybernetic limbs that the character does not biologically have do not provide new abilities, and is often considered wasteful or weird.
	
	\textbf{A character may not benefit from both cybernetic implants and permanent alchemical enhancements.} 
	
	Much like armors, Cybernetic bodyparts consist of their default form and modifications -or as they're known, implants- to those cybernetic bodyparts. Modifying your parts is not required, but many wastelanders find they give a bit more of an edge, if they can fork over the caps, that is. Implants can be added during or after installation of the main cyberware. 
	
	\vfill
	
	Artificial bodyparts have mod slots much like armors do; different parts have varied amount of mods they can allow simultaneously. It should be noted that not all implants are compatible with each other and thus they cannot be installed on the same cyberware. Likewise, multiples of the same implant do not stack. Often, both the cybernatic bodypart and modifications have bonuses to their user's functions, and these do not cancel each other out. 
	
	\bigskip
	
	When installing a cybernetic part, the process will take 24 hours and during this time the character getting the cybernetic is out of commission. The character or characters performing the operation roll their Medicine or Science skill to see how well the installation goes. \textbf{Characters without Field Doctor, Nurse or Tech-Raider P.A.S.T.s suffer a -20 to this roll.}. 
	
	\bigskip
	
	If the Roll is a success, the operation goes off without a hitch. A Critical Success halves the amount of days the operated character needs getting used to their new installation. A failure gives a Permanent -1 to either END or CHA, but the cybernetic is successfully installed. A Critical failure introduces a complication in the process that permanently damages the patient, giving them -1 to both END and CHA. 
	\vfill
	When a character has gained a new installation, they will suffer a temporary penalty of 1 to both END and CHA, due to their body and mind having to adjust to the changes made. When counting the days for adjusting, the penalty to END is included.
	...
	Characters with botched installation have above adjustment penalty in addition to their permanent ones.
	
	Re-activating bodyparts and adding modifications do not cause above adjustment period. Cybernetics can be disabled by EMP, or similar weapons. Disabled implants can be reactivated at a cybersurgery-capable clinic or by a character capable of crafting implants.
	
	Cybernetic implants can be found in \emph{\textbf{Wasteland Wares}}.
	
		\begin{verse}
		\emph{\textbf{Example 1:} Doc Red installs an Artificial Eye to Emerald Glint. Doc Red has the P.A.S.T. Field Doctor, which means they do not suffer a penalty for performing the surgery. Emerald Glint is out cold for 24 hours as Doc crafts the eye onto their body. Doc rolls Medicine, getting a Critical Success on their roll, meaning that Emerald will only need to recover and suffer from a temporary penalty for half the usual time. Emerald's END is 5 after the temporary penalty to their END from the surgery, meaning normally Emerald would suffer 10 days of temporary penalty (15 days-5 END). However, thanks to a smashing success on the surgery, Emerald has this time halved to 5 days instead.}
	\end{verse}
	
	\begin{verse}
		\emph{\textbf{Note:} taking cybernetic implants is risky and potentially dangerous. Side effects include, but are not limited to; dizziness, headaches, amnesia, loss of blood, limbs, intestines, and appetite. Avoid fatty and spicy foods after operation.}
	\end{verse}
...
%	\newpage
	...
	In the Wasteland and occasionally in more settled areas, moving and acting unnoticed can be considered a great advantage. To some it's a defining lifestyle, to others a tool of trade, and to many more a complete pain to crack down. Whether it is moving quietly, breaking a window with minimal noise, or avoiding another person doing these activities against you, sneaking is worthwhile to learn for a long and healthy life in the Wasteland. 
	
	Successful sneaking requires taking attention to the surrounding area and the actions taken. These include staying in the shadows, avoiding watchful eyes, as well as keeping the character's noise low, and their movement slow.
	
	\vfill
	
	Characters attempting to sneak roll an Opposed roll of Sneak vs. PER of the character that could spot them. If there are multiple NPC among spotters, GM can roll them collectively as a group. If half or more of the group's Sneak rolls are a success, they sneak past without a problem. Assist, Push the Limit and Distract are all applicable actions.
	
	The other source of bonuses and penalties is Visibility, which affects only the perceiving character's roll. This is discussed further in section \textit{Spotting sneaking characters} later in this section.
	
	%\medskip
	
	Though it can depend on the GM, if a character fails their Sneak-roll it doesn't necessarily mean that they are immediately discovered by the spotter; maybe they stepped on a dry branch, or knocked something over, enough to pique the spotter's interest. The spotter would become more alert as a result. This can, depending on the GM, give the Spotter a slight bonus to their roll, or just make the situation tense as the Spotter begins to look around.
	
%	\vfill
	
	If every character in the group fails their Sneak-roll, then it is safe to say they've bungled up the job well enough to be discovered outright. A Critical Failure might make things particularly tense, or make a sneaking situation into a chase scene instead. It is up to the GM to determine what is the severity of the failure, but know that combat doesn't have to be the only result.
	
%	\subsection{Sneaking in a group}
	
%	When characters are sneaking as a group, instead of every player character rolling separately, the group can appoint a specific person to take the lead. The leading character does an Opposed roll of their Sneak versus the opponent's Perception roll. Similar to Assisting, the other characters can help the leader in their roll.
	 
%	For each character with Sneak-skill of 25 or more, the leader can either gain +5 per character to their roll, or give a -5 cumulative penalty to the Opponent's roll instead. Characters with Sneak-skill below 25 do not provide bonus or penalty to either. In action, this can be thought of as carefully following the leader's lead or distracting the opponent.
	
% 	Besides perks, the one other source of bonuses and penalties for sneaking is Visibility, which affects only the perceiving character's roll. This is discussed further in \textbf{5.0.3: Spotting sneaking characters}.
	
%	\subsection{Sneaking alone}
	
%	Sometimes your character has to do things on their own, without the help of their teammates. Maybe they're scouting up ahead, or maybe they're the group's lone sniper making their way to a high spot. The roll in question is again an Opposed Roll of Sneak vs. opponent's PER.  
	
	\subsection*{Spotting sneaking characters}
	
	When characters, NPC or PC, want to spot sneaking characters, they roll Perception against the sneaking character's Sneak-skill in an Opposed Roll. Spotting character gets a bonus or penalty to their PER from Visibility, as per \textit{Table 7.2. under Combat Variables, in Chapter 6: Combat}. Bright light gives a bonus to the character's PER, while dark gives a penalty.
	
	When sneaking characters have been spotted, it can lead to conflict, violent or otherwise. 

% TODO: Before un-commenting this table, shift to longtblr -element as tabu -element is no longer supported ~Waak
...
%	\vfill
	...
	\begin{table*}[!t]
		...
		\begin{talltblr}
			[
			caption={NPC Disposition Levels},
			entry=none,
			label={Table:6.1}
			]
			{				
				colspec = {| X[l,1] | X[l,5] | X[l,1] |},
				row{odd} = {gray!30}, row{even} = {gray!10},
				rowhead = 1
			}
			\hline
	...
	Sleep Deprivation indicates the lack of sleep one can accumulate when on the road. It causes loss in SPECIAL stats as bodily functions begin to decrease. The effects of sleep deprivation are listed on Table 6.2.
	...
	For every hour of sleep, the awake hours of the character are decreased by four. For example, a character suffering from Major sleep deprivation (32+ awake hours) has to sleep for ten hours to restore herself from effects of sleep deprivation. It is not required that one sleeps all of their required rest in one go, and it is possible to recover Sleep Deprivation in 8 hour cycles. This can lower the level to a lesser effect, such as from Moderate to Minor, with a shift in penalties accordingly.
...
%	\end{table}
	...
	\begin{table}[!b]
		...
		\begin{tblr}
			...
			\hline
			Level 					& Awake Hours & Effect      \\ \hline
			Well-Rested            & -           & +1 INT, +1 PER \\
			Rested                 & 0           & -              \\
			Minor                  & $>$16       & -1 AGI               \\
			Moderate               & $>$24       & -1 AGI, -1 INT                 \\
			Major                  & $>$32       & -2 AGI, -2 INT, -1 PER, -1 END \\
			Severe                 & $>$40       & -3 AGI, -2 INT, -2 PER, -2 END \\
			Critical               & $>$48       & -3 AGL, -3 INT, -3 PER, -3 END \\ \hline
		\end{tblr}
	\end{table}
	
	Sleeping in a comfortable place such as on a good conditioned bed or with pleasant company without disturbance for at least 8 hours grants a state of well-rested, unless character still has lowered SPECIAL stats due to Sleep Deprivation. Well-rested gives a temporary bonus of +1 INT and +1 PER for END / 2 hours.
	
	Some consumables, such as coffee, can help a character to overcome the penalties caused by Minor Sleep Deprivation. However, no amount of coffee can supplement severe lack of sleep, not even in the Wasteland.
	
	\begin{verse}
			\emph{\textbf{Example:} Maabara has spent the last few days working on her alchemy recipes without so much as shut eye. She has managed to stay awake for 32 hours without any rest. Thus she is suffering from Major Sleep Deprivation, and suffers a penalty of -2 to her AGI and INT, as well as -1 to her PER and END. In order to recover from her sleep deprivation, Maabara has to sleep 8 hours (32/4= 8).}
	\end{verse}
	...
	Should a character remain without daily meals and drinks, her Hunger and Thirst will increase; on the first day, the character's END will drop regardless of what sustenance she missed. In the following days, her STR will decrease due to hunger and her PER will decrease due to thirst. Since characters require more water than food, their END will take additional decrease should thirst become too high. A character dies if their END reaches zero from these penalties. The rate of effects from hunger and thirst can be seen on Table 6.4.
	...
	\begin{verse}
	 	\emph{\textbf{Example 1:} Shining Example has gone without a meal for a day while staying hydrated. Due to hunger, his END has suffered a penalty of 1. On the second day, he skips a meal again but still has enough water to drink. His END remains at -1, but his STR now gets a penalty of 1 as well.}
	\end{verse}
	
	\begin{verse}
		\emph{\textbf{Example 2:} Emerald Glint has been without food and drink for three days. This means that she suffers following penalties: -2 END from overall lack of sustenance, -1 STR from lack of food and -2 PER and -1 END from lack of drink. This means her full penalties are -3 END, -2 PER and -1 STR. To remedy her state, she has to drink 3 additional drinks and eat 1 additional food item. To remedy the general fatigue, both food and drink are acceptable.}
	\end{verse}
...
%	\end{table}
	...
	\label{Table:7.3}
		\begin{tblr}
			...
			Stone wall                                           & 3           \\
			Bulletproof glass                                    & 5           \\
			Metal door, Armored vehicle, Sandbag wall            & 10		   \\ \hline
		\end{tblr}
	\end{table}
	...
	\begin{table}[t]
		...
		\begin{tblr}
			...
			Torso   			& Bleeding Status effect; 	Major Distraction  				\\
			Leg/Arm (for each) 	& +1 Movement AP cost                                       \\
			Head    			& Dazed Status effect; +1 AP and Strain cost for Spells		\\
			Wing    			& Can glide but not fly (one); Cannot fly or glide (both)   	\\ \hline
		\end{tblr} 
	\end{table}
	...
	\begin{table*}[t]
		...
		\begin{tblr}
			...
			{				
				colspec = {| l | l | X[c,2] |X[l,3] |},
				row{odd} = {gray!30}, row{even} = {gray!10},
				rowhead = 1
			}
			\hline
			\textbf{Name}   & \textbf{Effect}                  & \textbf{Duration} & \textbf{Removal}                  \\ \hline
			Burning         & -2 HP / round                    &    3     					& Use all AP \& Drop prone 	 \\
			Bleeding        & {-1 HP / round; \\ Minor Distraction} &    5     					& First Aid Kit           	 \\
			Blinded         & -2 PER; -5 Combat skills         &    3    				   	& -                    	\\
			Crippled        & As per Crippled limb             & {Minor: 24h \\ Major: Removal}	& Doctor's Bag, Hydra     \\
			Dazed           & Roll twice, pick worse result    &    3     					& Sedative                 \\
			Enraged         & {Berserk; +2 STR; \\ can only attack and move} &    3    		 	& Sedative                 \\
...
%	\clearpage
	...
	\subsubsection*{Use Item}
	Characters can also use items in combat that are not weapons. Character fishes out the item they want to use, use it and then discard or store the item. 
	The AP cost of this action is determined by where the item is coming from and if the item is concealed.
	
	Using an item from the inventory costs 8 AP.
	
	Using an item from a \textbf{Quick Slot} costs 3 AP.
	
	Using a concealed item costs an additional 2 AP.
	
	Using an item function on apparel or in the environment costs 2 AP.
...
%	Readying a concealed item costs an additional 2 AP.
	...
	\subsubsection*{Equip / Change Weapon}
	Equipping a weapon from inventory costs 8 AP. This action will change the weapon on one of the character's \textbf{Weapon slots}.
	
	Equipping a weapon listed on a \textbf{Weapon slot} or swapping between weapons in Weapon slots costs 3 AP.
	
	Equipping a concealed weapon costs an additional 2 AP.
	
	Unequipping a weapon without replacing it costs 3 AP.
	
	% Potential Bloat - redesign
...
%	Using a held item (other than a weapon), weapon accessories, PipBuck or an item in the environment usually costs 2 AP. If the task is uncommonly time-consuming or hard, the GM may declare a different AP cost for the action.
	...
	\subsubsection*{Drop Weapon}
	Sometimes characters want to drop or they're forced to let go of items in their hooves. Dropping a weapon costs 0 AP. % However, if a character carefully places down an item, the action costs 3 AP. The GM may declare a different AP cost for the action if appropriate.
	
	\subsubsection*{Pick Up Object}
	Picking an object up from the ground and stashing it in the character's inventory costs 6 AP.
	...
	\subsubsection*{Ready Action}
	There are moments where the character would prefer to let the enemy make a miscalculation and act upon that. To set up a Ready Action, the character designates an action they want to take and an associated trigger - the AP cost for the readied action is then removed from their AP. After the character's turn ends, if the associated trigger occurs before the start of the character's next turn, they can choose to use their designated action. 
...
%	\vfill
	...
	If the character is healed but remains in a Pain Threshold, such as going from 1 HP to 4 HP, GM rolls a 1d10 to replace earlier penalty from Pain Penalty (Table 7.9.). If the character is dying and is healed to a Pain Threshold, same rolling of a Pain Penalty applies.
...
%	\vfill
	...
	Characters can learn new spells in two ways - through leveling up or seeking out and experimenting on their own. As mentioned, every 5 levels the character can learn two new spells of their choosing, which are immediately added to their arsenal. It is best to consult the GM on spell choices. 
...
%	\newpage
	...
	\begin{longtblr}[
		caption={Action Reference},
		entry=none
		]{			
			colspec = {| X[l,2] | X[l,2]| X[l,3] | X[l,6] |},
			rowhead = 1,
			row{odd} = {gray!30}, row{even} = {gray!10},
			row{1} = {gray!50}
		}
		\hline
		\textbf{Category} & \textbf{Name} & \textbf{Cost} & \textbf{Notes} &  \\ \hline
		\SetCell{gray!50} & Initiative & - & 1d10+PER; Equal Initiatives compare AGI, Equal AGIs compare LCK. Highest goes first \\ \hline
		\SetCell{gray!50} Movement                & Ground Movement         & 1 AP per 2m / 1 hex                                                           &                 \\
		\SetCell{gray!50}                         & Flying                  & 1 AP per 2m / 1 hex                                                           & Crippled wings prevent flying              \\
		\SetCell{gray!50}                         & Swimming                & 2 AP per 2m / 1 hex                                                           & Cannot charge, cannot swim if 2 or more limbs Crippled  \\
		\SetCell{gray!50}                         & Climbing                & 3 AP per 2m / 1 hex                                                           & Cannot charge, cannot climb if 2 or more limbs Crippled   \\
		\SetCell{gray!50}                         & Difficult Terrain       & +1 AP to Movement                                                             & May require SPECIAL roll              \\
		\SetCell{gray!50}                         & Sprinting               & 1 Strain                                                            & Gain additional END/2 number of AP to Movement          \\
		\SetCell{gray!50}                         & Charging                & -                                                                             & +10 to melee/unarmed immediately after, deal DMG from dice at 4-6. Opponents gain +5 to hit \\
		\SetCell{gray!50}                         & Crawling                & 2 AP per 2m / 1 hex                                                           & Cannot do while flying                            \\
		\SetCell{gray!50}                         & Drop Prone              & -                                                                             & Considered Prone after                     \\
		\SetCell{gray!50}                         & Crawling                & 3 AP per 2m / 1 hex                                                           & Cannot do while flying                     \\
		\SetCell{gray!50}                         & Standing Up             & 4 AP                                                                          & When Crippled, needs assistance               \\
		\SetCell{gray!50}  Movement               & Jumping, Still Longjump & 3 AP                                                                          & STR $<$5, 2 meters/1 hex  STR 5-9, 4 meters/2 hex  STR 10+, 6 meters/3 hex                  \\
		\SetCell{gray!50}                         & Jumping, Running Start  & 2 AP                                                                          & 4 meters/2 hex of movement required, can jump STR in meters (STR/2 hex)                     \\
		\SetCell{gray!50}                         & Jumping, Up             & 3 AP                                                                          & STR $<$5, 0,5 meters    STR 5-9, 1 meter      STR 10+, 1,5 meters                           \\
		\SetCell{gray!50}                         & Withdraw                & 4 AP                                                                          & Does not provoke AoO, may Sprint          \\ \hline
		\SetCell{gray!50} Attack Actions          & Attack                  & Weapon-specific AP Cost                                                              & 1d100 result under or equal to Combat Skill results in a hit    \\
		\SetCell{gray!50}                         & Called Shot             & +2 AP                                                                         & Cripple body parts , -1 DT on target         \\
		\SetCell{gray!50}                         & Aim                     & +2 AP                                                                         & +10 to combat skill for next attack             \\
		\SetCell{gray!50}                         & Reload                  & Weapon-specific AP Cost                                                              &                                                 \\
		\SetCell{gray!50}                         & Casting a Spell         & Spell-specific AP \& Strain Cost                                                                &                                                 \\
		\SetCell{gray!50}                         & Sneak Attack            & +2 AP                                                                         & +15 to perform a Critical Hit          \\
		\SetCell{gray!50}                         & Attack of Opportunity   & -                                                                             & Max 5 AP cost for melee or unarmed.       \\ \hline
		\SetCell{gray!50} Combat Tricks           & Brace Weapon            & 1 AP                                                                          & Reduce STR Penalty by 2; Lower Burst penalty      \\
		\SetCell{gray!50}                         & Grapple, Start          & 5 AP                                                                          & Opposed Unarmed / STR        \\
		\SetCell{gray!50}                         & Grapple, Maintain       & 2 AP                                                                          & Opposed Unarmed / STR        \\
		\SetCell{gray!50}                         & Grapple, Overpower      & 4 AP                                                                          & Opposed Unarmed / STR        \\
		\SetCell{gray!50}                         & Grapple, Attack         & Weapon-specific AP Cost                                                              & Unarmed: no penalty      Melee, 1-H: Minor Distraction      Pistol: Major Distraction       \\
		\SetCell{gray!50}                         & Grapple, Pin            & 8 AP initiate, 4 AP maintain                                                  & Opposed Unarmed / STR (Attacker -30)                   \\
		\SetCell{gray!50} Combat Tricks           & Grapple, Tie Up         & 8 AP                                                                          & Opposed Unarmed / STR (Attacker -30); Grapple ends        \\
		\SetCell{gray!50}                         & Grapple, Move           & 4 AP + Movement                                                               & Opposed Unarmed / STR; Movement 3 AP per 2 m / 1 hex      \\
		\SetCell{gray!50}                         & Grapple, Escape         & 4 AP                                                                          & Opposed Unarmed / STR              \\
		\SetCell{gray!50}                         & Grapple, Toss           & 8 AP                                                                          & Opposed Unarmed / STR (Attacker -30); Grapple ends   \\
		\SetCell{gray!50}                         & Suppressive Fire        & 8 AP                                                                          & Moderate Distraction on Large Splash; -10 ammo     \\
		\SetCell{gray!50}                         & Trip                    & 5 AP                                                                          & Melee / Unarmed; On success target is Prone   \\
		\SetCell{gray!50}                         & Distract                & 4 AP                                                                          &       \\ \hline
		\SetCell{gray!50}  Defensive              & Dodge                   & From 1 AP to Maximum AP                                                       & Cannot be used if no movement allowed; -5 per use against one opponent \\
		\SetCell{gray!50}                         & Break Free              & 8 AP                                                                          & STR / AGI, LCK if GM allows     \\ \hline
		\SetCell{gray!50} Other Actions           & Ready Item              & 8 AP from inventory; 3 AP from QS                                             & +2 AP cost if concealed item       \\
		\SetCell{gray!50}                         & Ready / Change Weapon   & 8 AP from inventory; 3 AP from WS                                             & +2 AP cost if concealed item            \\
		\SetCell{gray!50}                         & Use Item / Function     & 2 AP                                                                          & GM may change AP cost to fit duration             \\
		\SetCell{gray!50}                         & Drop Item               & -                                                                             & If carefully dropped, costs 3 AP                    \\
		\SetCell{gray!50}                         & Pick Up Item            & 6 AP                                                                          &                                    \\
		\SetCell{gray!50}                         & Assist Ally             & 2 AP                                                                          & GM may change AP cost depending on situation              \\
		\SetCell{gray!50}                         & Use Skill / SPECIAL     & Easy, no rush: 4 Easy, rushed: 2 	Hard, no rush: 10 
		
		Hard, rushed: 5 & If rushed, -15 to Skill or SPECIAL roll; double penalty for Hard                            \\
		\SetCell{gray!50} Other Actions           & Maintain Spell          & Spell-specific AP \& Strain Cost                                                                &                               \\
		\SetCell{gray!50}                         & End Spell               & -                                                                             &                               \\
		\SetCell{gray!50}                         & Talking                 & -                                                                             & If influencing others, check Use Skill           \\ \hline
	\end{longtblr} 
	
	\begin{tblr}[
		caption={Combat Variable Reference},
		entry=none]
		{			
			colspec = {| X[l,2] | X[l,6] |},
			rowhead = 1,
