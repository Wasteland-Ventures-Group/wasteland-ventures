...
%	Having a teacher to coach the character reduces the required successful checks from 4 to 2.
	...
	Upon reaching 10th level, Zebras can channel their magic into permanent, powerful inscriptions after perfecting their craft with Brews and Talismans. These are the fabled \textbf{Enchantments}, and these can be learned from 10th level onwards like other concoctions with more time spent on the tinkering. When learning Enchantment recipes through experimentation, the character requires at least two successful checks, once per 8 hours of self-teaching. 
