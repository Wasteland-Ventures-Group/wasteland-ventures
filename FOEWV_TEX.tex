...
%	\end{center}
	...
	\textbf{Quirk - Grand Stand:} Once per session, you can roll Diplomacy or CHA in place of Thaumaturgy, and vice versa.
	...
	\textbf{Quirk - Guts:} Once per session when making an attack, gain +1 DMG for every Status Effect you're experiencing (excluding Mind-Controlled, Stunned, Dying, and Unconscious).
	...
	Shotguns, a subcategory of firearms, fire a hail of small pellets (often called ``buckshot'') that can be crippling at close ranges. Though the further they travel, the more the pellets spread. This is why all shotguns lose 2 damage dice at Medium ranges, and a total of 4 damage dice at Long ranges.
...
%	\newpage
	...
	Sneak skill rolls are opposed by a potential opponent's PER rolls. Like every skill, modifiers to both Sneak and PER vary from bonus of +50 to penalty of -50. Each modifier can be subtracted or added up to a maximum of +50 / -50. Difference between Sneak rolls and opposed PER rolls can however be up to a maximum of 100, with penalty of -50 on one and bonus of +50 on the other. Examples are detailed on Table 5.6 on page 64.
	...
	\begin{verse}
		\emph{\textbf{Example:} Doc Red wants to create a Chem that provides both HP and Strain when used. GM and him decide that Red will require a Healing Potion, 2 Blue herbs, and a freshly ground Jackalope Horn. They decide that the effect of the chem is +3 HP healed and +5 Strain recovered instantly. They agree that the potent nature of the Chem means Doc Red will require 5 successful Medicine rolls instead of 4. They calculate that the addiction chance from this Chem is 20\%, with -2 Potency and -1 END as a Withdrawal effect. After 6 days, Doc Red has successfully rolled Medicine 5 times and the Chem is complete}.
	\end{verse}
...
%	\end{verse}
	...
	% Have to check if we have any spells that require more than one turn to complete ~Waak
...
%	\begin{description}
	...
	Spirit Power rating is a number between 1 and 12. The exact effect of Spirit Power varies and are explained in future sections or in the details of each individual spirit.
