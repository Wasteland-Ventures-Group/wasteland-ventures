...
%	\vfill
	...
	You gain access to a special form that you can slip into at will. However, you cannot maintain this form safely for long; you can maintain the form for CHA number of rounds safely, and outside of that, each turn afterwards requires an Insanity roll, as the form begins to shake your mental fortitude. 
	...
	However, this otherworldly existence has its downside; You have 2 max HP less, and you have no Cutie Mark bonus to a skill. 
	
	You can choose any of the spirits in the Shaman list to be the source of your power, including the non-described Spirit of Chaos. You gain spells as you level-up and each Spirit gives you slightly different attributes to your spirit form:
	...
	\medskip
	\textbf{Spirit specific effects:}
	\medskip
	
	\textbf{Spirit of Embers:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item Non-Magic attacks deals Fire dmg.
		\item Immunity to Burning.
		\item +10 to Intimidation skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Freezing.
	\end{compactitem}

	\medskip
	\textbf{Spirit of Machines:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item When within a Small Splash Radius of you, allies have +5 Crit chance for 3 rounds.
		\item Immunity to Stunned.
		\item +10 to Mechanics skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Poisons.
	\end{compactitem}

	\medskip
	\textbf{Spirit of Nature:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item When within a Small Splash Radius of you, allies recover +1 HP per turn for 3 Rounds.
		\item Immunity to Poisons except Taint and Pink Cloud.
		\item +10 to Survival skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Stunned.
	\end{compactitem}
	
	
	\medskip
	\textbf{Spirit of Serenity:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item Non-Spell attacks deal Electricity dmg.
		\item Immunity to Dazed.
		\item +10 to Medicine skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Bleeding.
	\end{compactitem}

	\medskip
	\textbf{Spirit of Shadows:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item You are surrounded by a Small Splash area of darkness, giving enemies -15 to hit you for 3 rounds of combat.
		\item Immunity to Bleeding.
		\item +10 to Sneak skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Dazed.
	\end{compactitem}
	
	\medskip
	\textbf{Spirit of Streams:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item Non-Spell attacks deal Cold dmg.
		\item Immunity to Freezing.
		\item +10 to Science skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Burning.
	\end{compactitem}

	\medskip
	\textbf{Spirit of Trust:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item When within a Small Splash Radius of you, allies have +1 DT for 3 Rounds.
		\item Immunity to Mind-Controlled.
		\item +10 to Diplomacy skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Blinded.
	\end{compactitem}

	\medskip	
	\textbf{Spirit of Whispers:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item Non-Spell attacks can cause Enraged-status effect.
		\item Immunity to Blinded.
		\item +10 to Sleight skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Mind-Controlled.
	\end{compactitem}
	
	\medskip
	\textbf{Spirit of Chaos:}
	
	\textit{Bonuses:}
	\begin{compactitem}
		\item When within a Small Splash Radius of you, enemies suffer a +5 to their Crit Failure chance.
		\item Immunity to Enraged.
		\item +10 to Barter skill.
	\end{compactitem}
	
	\textit{Penalties:}
	\begin{compactitem}
		\item -1 END to resist Petrified.
	\end{compactitem}
...
%	\newpage
	...
	The other source of bonuses and penalties is Visibility, which affects only the perceiving character's roll. This is discussed further in \textit{5.0.3: Spotting sneaking characters}.
