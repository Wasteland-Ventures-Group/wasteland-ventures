...
%	Upon a successful hit, the attacker can choose to deal one less HP in damage and inflict a Crippled condition on the targeted limb. The Crippled condition is applied even if the deduction of damage would result in 0 damage dealt.
