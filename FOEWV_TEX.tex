...
%	\newpage
	...
	\begin{longtblr}[
		...
		\hline
		\textbf{Category} & \textbf{Name} & \textbf{AP Cost} & \textbf{Notes} &  \\ \hline
		...
		\SetCell{gray!50}                         & Sprinting               & All AP to Movement                                                            & Gain additional END/2 number of AP to Movement          \\
		...
		\SetCell{gray!50} Attack Actions          & Attack                  & Weapon-specific                                                               & 1d100 result under or equal to Combat Skill results in a hit    \\
		...
		\SetCell{gray!50}                         & Reload                  & Weapon-specific                                                               &                                                 \\
		\SetCell{gray!50}                         & Casting a Spell         & Spell-specific                                                                &                                                 \\
		...
		\SetCell{gray!50}                         & Grapple, Attack         & Weapon-specific                                                               & Unarmed: no penalty      Melee, 1-H: Minor Distraction      Pistol: Major Distraction       \\
		...
		\SetCell{gray!50} Other Actions           & Maintain Spell          & Spell-specific                                                                &                               \\
