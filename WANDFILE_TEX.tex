...
%	\bigskip
	...
	Discovered shortly before the war, kirin saw limited service at frontlines but made scary berserker-units using their Nirik-forms. In exchange for their service under banner of Equestria, kirins got their own Stable near their village in Peaks of Peril. The Stable was almost finished before last day - it was fully operational but not fully reinforced, which quickly lead to some issues.
	...
	\begin{description}
		...
		\item[Dragon Scales:] Being partly covered with scales, kirins gain an extra +1 DT when not wearing Heavy or Power armor.
...
%	\medskip
	\begin{quote}
		\begin{description}
			\item[$<$10 Potency] 	Small Burst 
			\item[10-19 Potency] 	Large Burst 
			\item[20+ Potency]  	Huge Burst 
		\end{description}
	\end{quote}
	\medskip
...
%	\medskip
	\begin{quote}
		\begin{description}
			\item[$<$10 Potency] 	Tiny Burst, 2 turns
			\item[10-19 Potency] 	Small Burst, 3 turns
			\item[20+ Potency]  	Large Burst, 4 turns
		\end{description}	
	\end{quote}
	\medskip
...
%	\medskip
	...
	% Table
	{
		...
		\begin{tabu} to 75mm{| X[l,4] | X[l,7] |}
			...
			Range     		&  -	\\
			Target      	&  Self	\\
			Area of Effect  &  Huge Burst area	 		\\
	...
	The caster can sense creatures within a Huge Burst Area with 100 \% accuracy, but creatures beyond that require a successful Thaumaturgy or CHA roll to locate accurately.
...
%	\medskip
	\begin{quote}
		\begin{description}
			\item[$<$10 Potency] 	Small Burst, 1+(5) DMG
			\item[10-19 Potency] 	Large Burst, 2+(5) DMG
			\item[20+ Potency]  	Huge Burst, 2+(7) DMG
		\end{description}	
	\end{quote}
	\medskip
	...
	The caster charms a Small burst area around them to allow themselves and any other creature within the area to see in the dark as if in daylight.
...
%	\medskip
	\begin{quote}
		\begin{description}
			\item[$<$10 Potency] 	Small Burst; 2 hours
			\item[10-19 Potency] 	Large Burst; 4 hours
			\item[20+ Potency]  	Huge Burst; 8 hours
		\end{description}	
	\end{quote}
%	\medskip
...
%	\medskip
	\begin{quote}
		\begin{description}
			\item[$<$10 Potency] 	Tiny Burst; 1 Rad 1x60 \%
			\item[10-19 Potency] 	Small Burst; 1 Rad 2x70 \%
			\item[20+ Potency]  	Large Burst; 2 Rads 2x70 \%
		\end{description}	
	\end{quote}
%	\medskip
...
%	\medskip
	...
	The target and everyone within Tiny Burst Template from them take damage according to the caster's Potency:
...
%	\vfill
	...
	If the attack successfully hits, the caster can move the target within a Large Burst Area. An Opposed roll of the Caster's PER vs the target's AGI determines if the target lands on the new hex Prone.
