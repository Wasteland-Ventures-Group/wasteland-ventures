...
\begin{document}
	...
	Changeling hives rarely have contact with one another, causing a large chasm of differences from hive to hive, from their tactics to gather energy, to their general opinion on other creatures and customs. The hive is often ran by a changeling queen, a taller and more powerful creature than the common changeling. She makes the decisions in the hive, with or without input from her subjects, and tend to live longer than her subjects. 
	...
	\begin{description}
		\item[Changeling Magic:] Changelings have a magic that is a mixture of Unicorn magic schools and their own unique spells. See Changeling Magic for details. Changelings start with one of the three shapeshift spells, Formshift, Bodyshift and Persuasion for free, and 3 additional spells. They learn a new spell every 5 levels (6th, 11th...). They can only learn one of the Shapeshift spells.
...
%	\bigskip
	...
	Changelings have a magic that is a blend of Unicorn magic and their own unique spells. Changelings start with a Shapeshift spell (Formshift, Bodyshift and Persuasion) for free, and 3 additional spells. They learn a new spell every 5 levels (6th, 11th...). The other shapeshift spells are not available later.
...
%	\medskip
	...
	The caster casts an Opposed roll of Thaumaturgy vs. INT against their target. If successful, the spell causes the target to gain Mind Control -status effect for Potency/3 turns. The spell's range is a Large Splash area centered on the caster. 
...
%	\medskip
	...
	% Table
	{
		...
		\begin{tabu} to 75mm{| X[l,4] | X[l,7] |}
			...
			Range     		&  -	\\
			Target      	&  Self	\\
			Area of Effect  &  Huge Splash area	 		\\
	...
	The caster can sense creatures within a Huge Splash Area with 100 \% accuracy, but creatures beyond that require a successful Thaumaturgy or CHA roll to locate accurately.
...
%	\medskip
	...
	The caster charms a Small Splash area around them to allow themselves and any other creature within the area to see in the dark as if in daylight.
...
%	\medskip
	...
	The caster makes targets around her momentarily so light that they can hover slightly above ground. The characters under the effects of this spell makes no sounds from walking or running. The spell's effect is limited to Small Splash area around the caster and any who step out of the area fall back onto ground.
...
%	\medskip
	...
	The caster makes targets around her momentarily in-tune with the earth underneath them. The characters under the effect gain an immunity to Difficult Terrain and a +20\% to Poison Resistance. The spell's effect is limited to Small Splash area around the caster and any who step out of the area lose the effect when their turn ends.
...
%	\medskip
	...
	The caster creates a bright, tiny ball of fire that explodes with a sparkling, glittery fallout that can cause Blinded -status and Minor Distraction on all within a Small Splash area of the detonation.
...
%	\medskip
	...
	The caster enchants their body to produce heat around them, essentially becoming a walking campfire, without being burning to the touch. Characters, including caster, in a Small Splash Area take half damage from Long Term Exposure to cold for the duration of this spell. They still take SPECIAL damage as normal.
	...
	The Phantom Lantern illuminates dark areas as if they were in bright daylight, removing visibility penalties from a Large Splash Area, which is centered on caster.
...
%	\vfill
	...
	If the attack successfully hits, the caster can move the target within a Large Splash Area. An Opposed roll of the Caster's PER vs the target's AGI determines if the target lands on the new hex Prone.
