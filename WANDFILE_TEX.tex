...
\begin{document}
	...
	\begin{description}
		...
		\item[Chitinous Shell:] Changelings have thick chitin that gives them armor-like properties. This provides +1 DT when not wearing Heavy or Power armor.
	\end{description}
	...
	Like their name implies, they have a great greed for gemstones. Due to this, they mostly inhabit caves and caverns, with strict hierarchy -a trait that remained in the mutated hellhounds- defining their way of life.
	
	Most packs of diamond dogs are led by an alpha, or if the alpha has deceased, by their companion, the matriarch. The alpha and matriarch both have a high social standing, with the alpha upholding and planning daily hunts and gem hauls, as well as having the final say on who does what. The matriarch makes sure the community works well together, negotiating and solving disputes; she also handles issues in pup-caring. Much like pony societies, each pack has their own characteristics. 
	...
	\begin{figure}[b]
		\centering
		\includegraphics[width=0.8\linewidth]{ART/Races/HIP_2}
	\end{figure}
...
%	\end{figure}
	...
	Yaks start with two Chants at their disposal at Character creation. Yak chants cannot be gained by level-up, and can only be learned. After all, chanting is a very exquisite art form. 
	...
	\begin{compactitem}
		\item Fire: Gain +1 END against Burning, and +1 DT against Fire dmg.
		\item Ice: Gain +1 END against Freezing and +1 DT against Cold dmg.
		\item Electric: Gain +1 END against Stun, and +1 DT against electric damage
		\item Earth: Gain +1 END against Bleeding and Petrified.
	\end{compactitem}
	...
	\begin{compactitem}
		...
		\item Earth: Orbs have 20\% base Cripple chance
	\end{compactitem}
	...
	\begin{compactitem}
		\item $<$10 Potency 		Size cat. -2
		\item 11-20 Potency 	    Size cat. -1
		\item 21+ Potency 			Size cat. 0
	\end{compactitem}
	...
	Example: Sapling Sprout casts Magnetize on her gun and on an enemy raider's metallic armor, with the two objects attracted to one another. This gives Sapling Sprout +10 on her Firearms skill in order to land a hit on that particular raider.
...
%	\vfill
	...
	To learn a new chant, the character must roll 4 successful checks of STR/CHA -2, the stat to be rolled can be decided by the player. Only one check may be made per day, and the successful checks do not have to be consecutive.
