...
\begin{document}
	...
	One of the more evasive races in the Equestrian Wasteland, the changelings are shapeshifters whose base form resembles a thin insect and pony hybrid. Commonly seen as Equestria's version of the boogeyman due to their transformative magic, many independent hives began to break out of their old molds after the Last Day; some for the better, some for the worse. Most settlements in Wasteland regard changelings with suspicion and fear, though there are exceptions.
	
	Changelings are unique in that they do not get the bulk of their nutrients from regular food, but rather they gather and eat emotions (Strain in this system) from ponies. To successfully steal emotions from them, the changeling takes the place of the pony's loved one and feeds off of their love. Changelings do not need to eat solid food, but they need to drink water or other fluids twice a day just like ponies do. While ineffective for sating their hunger, food-items do, when consumed, still give them stat bonuses and HP back.
	
	Changelings are capable of flight, but cannot operate clouds or use Aerial Maneuvers.	
	...
	\begin{description}
		...
		\item[Strain Feeder:] Changelings feed off Strain of others because they do not regenerate Strain on their own. See Changeling Magic for more details.
	...
	\begin{description}
		\item[Blessing of the Green:] Deer utilize their magic with potions made from plants and earth from their surroundings, much like how zebra use alchemy to brew their potions. They can choose 3 alchemical recipes alongside Brew Base at 1st level, and gain 2 new recipes every 5 levels after (6th, 11th...).
...
%	However, despite their strict social hierarchy, members are free to roam if they want to, and can rise up in ranks through recognition as a valuable member. As a general rule: the higher the rank, the more gemstones the diamond dog has on them. 
	...
	\begin{description}
		...
		\item[Delicate Claws:] Harpies have slimmer talons than griffons do, allowing for more precise movement. They have +5 to Sleight and their Use Item -action costs 1 AP less, to a minimum of 1.
...
%	\bigskip
	...
	\section*{Core Races}
	\addcontentsline{toc}{section}{Core Races}	
	...
	\section*{In Loving Memory}
	\emph{\textbf{Ghoul-only trait}}
	
	You have a sentimental item that you have carried with you through the apocalypse and the following years since; maybe an old letter from a loved one, an engraved lighter or a photo album, anything somepony else might consider unnecessary junk. Something that is immeasurably important to you. It helps you feel sane and normal despite what your mirror shows you, and allows you to connect to your past and your sense of self.
	
	For as long as you have the item in question, you have the following bonuses:
	Once per day, you may focus on your item and gain +5 to a Skill covered by your P.A.S.T.
	You have a +2 END against Mental Status effects and gaining insanity doesn't give you Enraged-status effect. If your Insanity is maxed out, you can roll END or CHA twice and pick the better result to resist going feral instead of turning immediately. 
	
	However, losing the object in question will start your rapid descent to ferality. Each day that you are without your item, you have to roll Insanity, regardless of your current Rads. After CHA/2 days without your item, regaining your item will not prevent the need to roll Insanity, as the stress of the situation has deteriorated your mental state.
	
	If you do recover the item or find a new focus before this time limit is up, you recover from the trauma of the situation and you no longer need to roll for Insanity. Your current Insanity counter is also lowered by two upon recovery or rediscovery.
	...
	\section*{Songbird}
	\emph{\textbf{Griffon and Hippogriff-only trait}}
	
	Some creatures see Griffons as brutish thugs dealing with blood and caps, or as heartless merchants dealing caps and blood. Hippogriffs face similar challenges, being often considered dumb oddballs. 
	
	Some see griffons and hippogriffs like you, with a gift of song in your voice. Your voice has an exceptional melodious quality that calms down those close to you and even helps them focus. Alas, your sweet voice is quite lacking when it comes to roaring timbre.
	
	You can always use Diplomacy-skill when making Assist-rolls, and aren't required to know a spell to assist in spellcasting. 
	Your sweet, gentle voice can even soothe distress; Once per day, your song removes 1 Insanity point from one individual.
	
	As a downside, you lose the Griffon racial ability "Predator" or Hippogriff racial ability "Birdbrain" and have a -10 to Intimidation-skill.
	...
	\section*{Trick Wings}
	\emph{\textbf{Pegasus and Bat Pony-only trait}}
	
	Your wings are kind of petite and particularly bendy, enabling you to use them for delicate work far more efficiently than most of your kin or griffons with their huge wings.
	
	You can use your wings to pick locks without bobby pins and a screwdriver. Likewise, Grapple-actions performed by you have a +1 and +10 to STR and Unarmed respectively, and you gain a +10 Sleight when hiding holdout weapons with your wings.
	
	When you Trip or Distract with your wings, you have +10 to the roll.
	
	As a downside, you never were a very skilled flier and your Potency is halved in all Aerial Maneuvers.
	...
	When taking a form of a magic-casting race such as unicorns, the changeling's magical aura's color is not disguised alongside their form. If they take the form of a flying race, they do not gain access to Aerial Maneuvers or ability to manipulate clouds.
...
%	\medskip
	...
	The caster summons an ethereal, otherworldly cloud that rains down silver rain. The allies that are hit by this rain regain HP each turn for the duration of this spell. If the ally moves away from under the cloud, the effect stops after their next turn.
	
	The cloud can be moved by the caster, appearing in the spot she wants it to appear in. Moving the cloud costs 1 AP per 2 meters/1 Hex; the cloud cannot sprint or charge. The cloud does not hamper visibility, nor can it be manipulated by pegasi and griffins due to its magical nature.
	
	The size and healing capability of the cloud depends on the caster's Potency:
	
	\begin{quote}
		\begin{description}
			\item[$<$10 Potency] 	Tiny Splash, 1 HP/round
			\item[10-19 Potency] 	Small Splash, 2 HP/Round
			\item[20+ Potency] 		Large Splash, 2 HP/Round
		\end{description}	
	\end{quote}
