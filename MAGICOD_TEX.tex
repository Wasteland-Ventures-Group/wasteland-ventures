...
\begin{itemize}
	...
	\item Arcane - Instead of Status Effects, deals extra (1) damage.
	\item Electricity - Can inflict with Stun, and stun robots and Power Armor
\end{itemize}

When casting, the caster denotes what element she uses with her Arcane Blast. The AP cost for the spell is 4 and the Strain cost is 1. The attack deals magical energy damage equal to Potency+(2). The caster must make a ranged attack roll with her \textbf{Thaumaturgy} skill in order to hit the target. 
...
%	The simplest version of Arcane Blast is a bolt of energy that deals damage to a single target. The AP cost for the spell is 3 and the Strain cost is 1. The attack deals magical energy damage equal to Potency+(2). The caster must make a ranged attack roll with her \textbf{Thaumaturgy} skill in order to hit the target.
...
The caster fills an area with arcane magic, making a curtain of energy that harms and affects anyone that tries to pass through it. The specifics effects of Wall of Energy depend on the substance chosen.
