...
\begin{document}
	...
	\begin{verse}
		...
		\textbf{Irradiated Burst (1/min, 8 AP):} Having soaked up radiation, the Glowing One can expel Rads in a Splash around it, in a Small Splash area centered on the ghoul. This attack gives 1 Rad Token at 5x50\% chance.
		
		\textbf{Irradiated Presence:} Glowing Ones positively glow with radiation - hence their name. Being close to them heals ghoulified characters and damages non-ghouls. Each turn spent within a Small Splash area around the Glowing one gives 1 Rad Token at 1x40\% chance.
		
		\textbf{Quick Runner:} Glowing Ones are fast, and due to this they get a +2 to their Initiative rolls.
		
		\textbf{Illuminated Body:} The Glowing Ones constantly emit a sickly glow from their body, meaning that they have -20 penalty on Sneak. In addition, within Large Splash area of the ghoul everyone ignores 10 points of Visibility penalties from darkness, including the Glowing One.
		
		%"and within Large Splash area of the ghoul everyone ignores X points of visibility penalties from darkness"
	...
	\begin{verse}
		...
		\textbf{Pink Cloud Hazard:} Piercing the ghost's suit releases the Pink Cloud inside the suit on a Tiny Splash area for two rounds. Because Ghosts are technically tiny containers, the Pink Cloud is concentrated in higher doses; Staying in this area removes 1 HP token per round from the target. Should the Ghost Sprint or Charge, they'll leave behind a line of Pink Cloud for 2 turns.
	...
	\begin{verse}
		...
		\textbf{Combustion (7 AP):} One of the innate abilities the magical Puckwudgie has is the ability to create grenade-like explosions around it. The attack is a Tiny Splash area, with the range of 10/20/40 meters. The attack deals 2+(2) damage and follows the rules for explosives.
