...
%	\addcontentsline{toc}{subsection}{Ghoul-Dragon}
%	\begin{quote}
...
%	\subsubsection*{Additional Combat Details:}
%	\begin{verse}
%		\textbf{Irradiated Firebreath (10 AP):} Ghoul-dragon's fire breath has been thoroughly irradiated. The fire breath can take two forms: 
...
%		\textbf{Bite (7 AP):} A mighty jaw with rows of razor sharp fangs. Deals 6+(3) damage, and ignores 4 DT. Ghoul-Dragons have Reach of 6 meters (3 hexes).
		
%		\textbf{Rend (5 AP):} The dragons' claws are sharp and capable of ripping apart metal and stone. The attack deals 3+(5) damage, and ignores 2 DT. Dragons have Reach of 6 meters (3 hexes).
		
%		\textbf{Non-Flying:} Ghoul-Dragons have lost their capability to fly due to necromantic magic corrupting them. 
...
%		\textbf{Rad Resistant:} Ghoul-dragons are very resistant to Radiation. Their rad resistance is 80.
%	\end{verse}
