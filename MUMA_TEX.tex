...
--------------------------------------
	...
	\begin{compactitem}
		...
		\item Magical Component (1d4 u.)
		\item Gun Component (1d4 u.)
		\item Ripper (1)
	\end{compactitem}
...
%	}
	...
	\begin{compactitem}
		...
		\item Martial Component (1d4 u. Survival doubles u.)
	\end{compactitem}
...
%	}	
	...
	\begin{verse}
		...
		\textbf{Mercenary Magic} Though mercenaries are most commonly griffons often called Talons, a few ponies and zebras have been known to pick up the trade. Thus, magic is an asset to them.
				\begin{compactitem}
			\item Earth Ponies: Branch of Sight or Might
			\item Pegasi and Griffons: All Maneuvers
			\item Unicorn: General, Enchantment and Medical Magic Schools
			\item Zebra: Alchemical Medicine and Talismans, Shaman; Possession Spirits or Spirit of Machines or Spirit of Serenity
		\end{compactitem}
...
\noindent
\textbf{Resistances} Poison 20\%, Radiation 5\%%, Fire +3 DT, +5 END vs Heat exposure % \emph{none} %
...
%	}
	...
	\noindent
	\textbf{Explosives} 65, \textbf{Melee} 50, \textbf{Sneak} 60, \textbf{Thaumaturgy} 50, \textbf{Unarmed} 45 
...
\noindent
\textbf{Firearms} 40, \textbf{Intimidation} 50, \textbf{Melee} 40, \textbf{Sneak} 30, \textbf{Thaumaturgy} 35, \textbf{Unarmed} 40
...
--------------------------------------		 
		...
		\textbf{Raider Magic:} As ponies, zebras and griffons, Raiders are capable of Magic. They tend to favor combat-focused magic, and forgo protective ones. Raiders have 2-3 spells available to them.
				\begin{compactitem}
			\item Earth Ponies: Branch of Might
			\item Pegasi and Griffons: Agility-based Maneuvers
			\item Unicorn: Conjuration and Illusion Magic Schools
			\item Zebra: Alchemical Drugs and Talismans, Shaman; Possession Spirits or Spirit of Embers or Shadows
		\end{compactitem} 
		
%		Earth Ponies tend to use spells from Branch of Might, Pegasi and Griffons lean towards Agility Maneuvers and Unicorns prefer Conjuration and Illusion magic schools. Zebra Raiders prefer volatile Spirits such as Embers or Shadows. 
...
\noindent
\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 60, \textbf{MEWs} 60, \textbf{Melee} 40,\textbf{Sneak} 60, \textbf{Thaumaturgy} 50, \textbf{Unarmed} 40 
...
--------------------------------------
		...
		\textbf{Slaver Magic:} Slavers are composed of many different races. 
				\begin{compactitem}
			\item Earth Ponies: Branch of Charm and Sight
			\item Pegasi and Griffons: Agility and Charisma-based Maneuvers
			\item Unicorn: Enchantment and Perception Magic Schools
			\item Zebra: Alchemical Drugs and Talismans, Shaman; Spirit of Machines or Whispers
		\end{compactitem}
		%Earth Ponies favor Branch of Charm and Sight, Pegasi and Griffons favor Charisma and Agility-based Maneuvers and Unicorns tend to lean towards Enchantment and Perception magic schools.
...
%		\textbf{Rad Resistant:} Slavers commonly have 5\% natural Radiation resistance, but most equip armor fitting to increase their tolerance against the magical fallout.
	...
	\begin{wrapfigure}{R}{0pt}
		\includegraphics[width=0.5\linewidth]{"ART/Enemies/slavers"}
	\end{wrapfigure}
	...
	\begin{quote}
		\emph{``This is your garden variety viper turned huge and multi-headed, kind of like a tiny Hydra, except it doesn't have a lizard-like body. What it does have is poisonous fangs and in some cases, habit of squeezing their targets lifeless. What is worse is that all the heads are poisonous, making them more formidable than any would prefer. At least they make fantastic boots.''}
...
\noindent
\textbf{STR} 6, \textbf{PER} 6, \textbf{END} 5, \textbf{CHA} 5, \textbf{INT} 3, \textbf{AGI} 6, \textbf{LCK} 7

\noindent
\textbf{Sneak} 60, \textbf{Unarmed} 70 %\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 60, \textbf{MEWs} 60, \textbf{Melee} 40, 

--------------------------------------

\noindent
\textbf{HP} 8, \textbf{DT} 1, \textbf{AP} 10$^{\dag}$, \textbf{Size} 0, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Poison 50\%, Radiation 20\% % \emph{none} %  ,% +2 END vs Cold exposure Cold +2 DT,  % 
...
--------------------------------------
		...
		\textbf{\dag Multiple Heads:} Snakes can control their heads independently from each other, giving the creature more sources to attack with. The snake's AP is 10 + the number of heads it has. Snakes' heads suffer Crippled -status effect only if all heads are crippled.
...
%		\textbf{Rad Resistant:} Despite being a mutated creature, snakes do not have a high tolerance to Rads. Their Rad resistance is 20.
	...
	\begin{compactitem}
		\item Venom Sac (1 u.)
		\item Hide (1 u.)
		\item Teeth (6 u., Survival doubles u.)
		\item General Meat, raw (1 u. Survival doubles)
	\end{compactitem}
...
\noindent
\textbf{STR} 7, \textbf{PER} 6, \textbf{END} 6, \textbf{CHA} 4, \textbf{INT} 3, \textbf{AGI} 6, \textbf{LCK} 7

\noindent
\textbf{Sneak} 65, \textbf{Unarmed} 75 %\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 60, \textbf{MEWs} 60, \textbf{Melee} 40, 
...
\begin{verse}
	...
	\textbf{Venomous Spit (5 AP):} Much like certain species of cobras, the three-headed snake can spit out venom from its fangs. This attack deals 2+(3) damage, and if it pierces DT, can cause the following effects, with 2x50\% chance of poisoning: 
	\begin{compactitem}
		\item On skin-contact, this venom causes a burning sensation and painful blisters, giving the target Burning Status effect. 
		\item If the venom gets to the eyes, the target suffers a penalty of -2 to PER when using eye-sight, as well as a -5 to Combat skills.
		\item Note: Snakes have either Venomous Spit or Constrict attack at their disposal
...
\noindent
\textbf{STR} 4, \textbf{PER} 8, \textbf{END} 5, \textbf{CHA} 4, \textbf{INT} 3, \textbf{AGI} 7, \textbf{LCK} 5

\noindent
\textbf{Sneak} 55, \textbf{Unarmed} 55 %\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 60, \textbf{MEWs} 60, \textbf{Melee} 40,

--------------------------------------

\noindent
\textbf{HP} 7, \textbf{DT} 0, \textbf{AP} 13, \textbf{Size} -1, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Poison 70\%, Radiation 30\% % \emph{none} %  ,% +2 END vs Cold exposure Cold +2 DT,  % 
...
--------------------------------------
	...
	\begin{verse}
		...
		\textbf{Web (5 AP):} The spider entangles its target in a flung webbing, slowing them down. The target suffers a +1 AP to Movement actions. The range is 4/8/12.
		
--------------------------------------
		
		\textbf{Balanced:} Due to having 8 legs, spiders have high balance. Spiders receive +20 to resist Trip, and they ignore up to 4 crippled legs' effects.
...
\noindent
\textbf{STR} 6, \textbf{PER} 8, \textbf{END} 5, \textbf{CHA} 4, \textbf{INT} 3, \textbf{AGI} 7, \textbf{LCK} 5

\noindent
\textbf{Sneak} 45, \textbf{Unarmed} 70 %\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 60, \textbf{MEWs} 60, \textbf{Melee} 40,

--------------------------------------

\noindent
\textbf{HP} 11, \textbf{DT} 3, \textbf{AP} 13, \textbf{Size} 1, \textbf{Karma} 0
...
--------------------------------------
	...
	\begin{verse}
		...
		\textbf{Web (5 AP):} The spider entangles its target in a flung webbing, slowing them down. The target suffers a +1 AP to Movement actions. The range is 6/12/18
...
\noindent
\textbf{STR} 5, \textbf{PER} 6, \textbf{END} 7, \textbf{CHA} 4, \textbf{INT} 4, \textbf{AGI} 5, \textbf{LCK} 3

\noindent
\textbf{Firearms} 45, \textbf{MEWs} 35, \textbf{Sneak} 50, \textbf{Unarmed} 40 %\textbf{Barter} 70, \textbf{Diplomacy} 60, , \textbf{Melee} 40,

--------------------------------------

\noindent
\textbf{HP} 5, \textbf{DT} 2, \textbf{AP} 12, \textbf{Size} -2, \textbf{Karma} 0

%\noindent
%\textbf{Potency} 10, \textbf{Strain} 20

\noindent
\textbf{Immunities}  Poison, Radiation, Taint  %Fire, \emph{none}

\noindent
\textbf{Resistances} \emph{none} % Poison 70\%, Radiation 30\% %   ,% +2 END vs Cold exposure Cold +2 DT,  % 
...
--------------------------------------	
		...
		\textbf{Self-destruct:} Upon reaching 0 HP, Spider-bot explodes with a Small Splash template centered on itself. Deals 2+(2) damage.
		
--------------------------------------
		
		\textbf{Combat Inhibitor:} Spider-bots are equipped with a combat inhibitor, that help them separate friends from woes. Combat inhibitor can be hacked with Science to various ends, such as shutting down the robot. Destroying the combat inhibitor turns the Spider-bot against anything around them.
...
%		\textbf{Rad Immunity:} Due to not being alive, radiation has no effect on Spider-Bots.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Scrap Metal, common (1d4 u., Mechanics doubles u.)
		\item Scrap ArcanoTech, common (1d4 u., Science doubles u.)
		\item Magical Component (1d2)
		\item Ammo - Gem Pack, (1d4 u., Luck doubles u.)
		\item Junk (1d4)
	\end{compactitem}
	...
	Spider-Bots were created as a cheap, mobile yet effective defense mechanism for various commercial uses. Mimicking their more lively cousins, Spider-Bots carry around an arsenal of sedatives to utilize on ``trespassers'', as well as shocking ability and ranged magical attack for the more troublesome ``hoodlums''. 
...
\noindent
\textbf{STR} 5, \textbf{PER} 4, \textbf{END} 7, \textbf{CHA} 4, \textbf{INT} 6, \textbf{AGI} 5, \textbf{LCK} 3

\noindent
\textbf{Melee} 60, \textbf{Sneak} 40, \textbf{Unarmed} 55 %\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 35, 

--------------------------------------

\noindent
\textbf{HP} 5, \textbf{DT} 2, \textbf{AP} 12, \textbf{Size} 0, \textbf{Karma} 0
...
--------------------------------------
	...
	\begin{verse}
		...
		\textbf{Poison Barb (4 AP):} Spore Carriers fire the barbs from their body at their foes (Melee, range 10/20/30), dealing 2+(2) damage. If this attack's damage overcomes DT, it has a 2x40\% chance to cause a hallucination on its target for 3 rounds. If the target is poisoned, they will suffer Dazed- status effect.
...
--------------------------------------
		...
		\textbf{Organized:} Spore Carriers have hierarchy of leadership. They strike as units and groups of various sizes, usually under at least one alpha. Eliminating a leader often leaves rest of the  group at disarray and demoralized, giving them a -5 to all skill actions.
		
		\textbf{Painless:} With their host already dead, Spore Carrier has no Pain Thresholds.
...
%		\textbf{Rad Immunity:} Due to Spore carriers being deceased ponies animated by a plant, they do not suffer from Radiation.
	...
	\begin{compactitem}
		...
		\item Spore plant Sap (1d4, Survival doubles u.)
		\item Green Herbs (1d8 u.)
		\item Blue Herbs (1d4 u.)
	\end{compactitem}
	...
	Generally, this transformation takes a few weeks, with first symptoms showing up within a few days. The symptoms include shortness of breath, dizziness, orange spots appear on the body and finally, the victim's body starts to gain bark-like properties, before death takes them. 
	
	Thankfully, there is a cure for the affliction; a potion made of the Spore plant's sap and few Green herbs boiled in clean water takes care of the pollen when digested for every day about a week. 
...
\noindent
\textbf{STR} 4, \textbf{PER} 6, \textbf{END} 7, \textbf{CHA} 2, \textbf{INT} 1, \textbf{AGI} 4, \textbf{LCK} 6

\noindent
\textbf{Melee} 60, \textbf{Sneak} 20, \textbf{Unarmed} 60 %\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 35, 

--------------------------------------

\noindent
\textbf{HP} 6, \textbf{DT} 1, \textbf{AP} 12, \textbf{Size} -1, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} +2 END vs Burning- status effect %\emph{none} % Poison 70\%, Radiation 30\%    ,% +2 END vs Cold exposure Cold +2 DT,  % 
...
%		\textbf{Poison Immunity:} The I.M.P experimentation made to the swamp flower has resulted in the resulting Spore plant being immune to poisons.
	...
	There is a cure to the infection caused by the Spore Plant; a potion made of the Spore plant's sap and few Green herbs boiled in clean water takes care of the pollen when digested for every day about a week.
...
\noindent
\textbf{STR} 5, \textbf{PER} 7, \textbf{END} 5, \textbf{CHA} 6, \textbf{INT} 5, \textbf{AGI} 5, \textbf{LCK} 4

\noindent
\textbf{MEWs} 60, \textbf{Sneak} 60 % \textbf{Unarmed} 60 \textbf{Melee} 60,%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45,  

--------------------------------------

\noindent
\textbf{HP} 7, \textbf{DT} 2, \textbf{AP} 12, \textbf{Size} -2, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} \emph{none} %+2 END vs Burning- status effect % % Poison 70\%, Radiation 30\% +2 END vs Cold exposure Cold +2 DT,  % 
...
--------------------------------------
		...
		\textbf{Combat Inhibitor:} Sprite Bots are equipped with a combat inhibitor, that help them separate friends from woes. Combat inhibitor can be hacked with Science to various ends, such as shutting down the robot. Destroying the combat inhibitor turns the Sprite Bot against anything around them.
...
%		\textbf{Rad Immunity:} Due to not being alive, radiation has no effect on Sprite bots.
	...
	\begin{compactitem}
		...
		\item Magical Component (1 u.)
		\item Ammo - MFC
		\item Junk (1d4)
	\end{compactitem}
	
	\begin{wrapfigure}{R}{0pt}
		\includegraphics[width=0.5\linewidth]{"ART/Enemies/spritebot"}
	\end{wrapfigure}
...
\noindent
\textbf{STR} 7, \textbf{PER} 6, \textbf{END} 8, \textbf{CHA} 5, \textbf{INT} 6, \textbf{AGI} 4, \textbf{LCK} 7

\noindent
\textbf{Barter} 50, \textbf{Explosives} 50, \textbf{Intimidation} 70, \textbf{Mechanics} 60, \textbf{MEWs} 70 \textbf{Science} 70, \textbf{Thaumaturgy} 60,  

--------------------------------------

\noindent
\textbf{HP} 18, \textbf{DT} 0$^{\dag}$, \textbf{AP} 12, \textbf{Size} 0, \textbf{Karma} Varies
...
\noindent
\textbf{Resistances} Poison 10\%, Radiation 5\% %\emph{none} %+2 END vs Burning- status effect %   +2 END vs Cold exposure Cold +2 DT,  % 
...
--------------------------------------
	...
	\subsubsection*{Additional Combat Details:}
	\begin{verse}
		\textbf{\dag Wasteland Weaponry:} As sentient creatures, Steel Rangers sport a myriad of weaponry, and take great liking in high-end magical weapons. Their patrols wear Power Armor exclusively, but Steel Stranger Scribes can be seen wearing lighter armor.
		
-------------------------------------- 

		\textbf{Steel Ranger Magic:} Being ponies, Steel Rangers have access to magic. Pegasi are practically non-entity in the Steel Ranger ranks, so Earth Pony and Unicorn magic is most common. 
		\begin{compactitem}
		\item Earth Ponies: All Branches
		\item Unicorn: Conjuration, Protective and Medical Magic Schools
		\end{compactitem}
%		Earth pony Steel Rangers often use all Branches of their magic, while Unicorns favor Conjuration, Protective and Medical magic schools.
...
--------------------------------------
		...
		\textbf{Organized:} Steel Rangers have hierarchy of full military leadership. They strike as units and groups of various sizes, usually under at least one commander. Eliminating such a leader often leaves rest of the  group at disarray and demoralized, giving them a -5 to all skill actions.
...
%		\textbf{Rad Resistant:} Steel Rangers commonly have 5\% natural Radiation resistance, but most equip armor fitting to increase their tolerance against the magical fallout.
	...
	\begin{compactitem}
		\item Main Weapon (1 u.)
		\item Additional Weapon (1 u.)
		\item Power Armor (1 u., cannot be used without penalties without \emph{Power Armor training})
		\item Skill Book (1 u. LCK -20 to obtain)
		\item Ammo - Gem Pack or MFC (1d6 u. Survival doubles u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 12, \textbf{PER} 6, \textbf{END} 10, \textbf{CHA} 3, \textbf{INT} 5, \textbf{AGI} 6, \textbf{LCK} 8

\noindent
\textbf{Sneak} 80, \textbf{Unarmed} 60 %\textbf{Melee} 60,%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  

--------------------------------------

\noindent
\textbf{HP} 22, \textbf{DT} 6, \textbf{AP} 13, \textbf{Size} 4, \textbf{Karma} 0

%\noindent
%\textbf{Potency} 10, \textbf{Strain} 20

\noindent
\textbf{Immunities} Radiation, Taint  %Fire, \emph{none} Poison, 

\noindent
\textbf{Resistances} Poison 90\% %+2 END vs Burning- status effect % % , Radiation 30\% +2 END vs Cold exposure Cold +2 DT,  % \emph{none}
...
--------------------------------------
	...
	\begin{verse}
		...
		\textbf{Destroyer (4 AP):} Star-Spawn can and often do remove covers and obstacles from the battlefield with a single strike of paw; this action affects Large Burst Area and destroys any Obstacle with 3 or less DT. Obstacles that provide more DT have their DT halved (rounded down).
...
\noindent
\textbf{STR} 8, \textbf{PER} 4, \textbf{END} 7, \textbf{CHA} 3, \textbf{INT} 2, \textbf{AGI} 3, \textbf{LCK} 5

\noindent
\textbf{Sneak} 30, \textbf{Unarmed} 60 %\textbf{Melee} 60,%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  

--------------------------------------

\noindent
\textbf{HP} 12, \textbf{DT} 4, \textbf{AP} 11, \textbf{Size} 2, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Radiation 20\% %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT, Poison 90\%  % \emph{none}
...
%		\textbf{Rad Resistant:} Despite being mutated by the magical fallout, Tankbugs deal poorly with very irradiated surroundings, though they can shrug off background radiation with ease. Their Rad resistance is 20.		
	...
	\begin{compactitem}
		...
		\item General Meat (1d8, Survival doubles u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 7, \textbf{PER} 5, \textbf{END} 6, \textbf{CHA} 5, \textbf{INT} 6, \textbf{AGI} 6, \textbf{LCK} 6

\noindent
\textbf{Barter} 55, \textbf{Diplomacy} 55, \textbf{Firearms} 45, \textbf{Melee} 50, \textbf{Sneak} 40, \textbf{Thaumaturgy} 45, \textbf{Unarmed} 50  

--------------------------------------

\noindent
\textbf{HP} 11, \textbf{DT} 0, \textbf{AP} 13, \textbf{Size} 0 \textbf{Karma} Varies

\noindent
\textbf{Potency} 5, \textbf{Strain} 15

\noindent
\textbf{Immunities} \emph{none} %Radiation, Taint Fire,  Poison , 

\noindent
\textbf{Resistances} Poison 10\% (20\% if Zebra), Radiation 5\% %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT,   % \emph{none}
...
--------------------------------------
		...
		\textbf{Thug Magic:} Being ponies, griffons and zebras, Thugs have magic available to them, though they usually aren't very adept at using their innate skills. 
		\begin{compactitem}
			\item Earth Ponies: Branch of Sight
			\item Pegasi and Griffons: Endurance-based Maneuvers
			\item Unicorn: General and Conjuration Magic Schools
			\item Zebra: Alchemical Drugs and Talismans, Shaman; Possession Spirit
		\end{compactitem}
%		Earth Ponies lean towards Branch of Might, while Pegasi and Griffons tend to focus on Endurance-based Maneuvers. Unicorn thugs often lean towards General and Conjuration, and zebra thugs lean towards alchemy in favor of Spirits. If a Shaman is around, they would likely use the more straightforward Possession Spirits.
...
\noindent
\textbf{STR} 7, \textbf{PER} 7, \textbf{END} 7, \textbf{CHA} 5, \textbf{INT} 6, \textbf{AGI} 4, \textbf{LCK} 6

\noindent
\textbf{Sneak} 50, \textbf{Unarmed} 60 %\textbf{Melee} 60,%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  

--------------------------------------

\noindent
\textbf{HP} 17, \textbf{DT} 2, \textbf{AP} 12, \textbf{Size} 1, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} \emph{none} %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT, Poison 90\%  % Radiation 20\%
...
--------------------------------------
	...
	\begin{verse}
		...
		\textbf{Magic Resistant:} Unlike most non-mutated creatures, Timberwolf is made from twigs held together by raw, eerie magic. Due to this, they're quite resistant to magical attacks; spells that target the Timberwolf have -20 to Thaumaturgy. In addition, MEWs DT Reduction doesn't work on Timberwolves.
		...
		\textbf{Unify:} Timberwolves are magical constructs made of wood, so they can increase their Size by merging together to create what is known as Timberwolf King. A larger Timberwolf has a +5 to Unarmed, -5 to Sneak and +2 HP for each size category it grows in size. A minimum of three Timberwolves are needed to go up in size category.
...
%		\textbf{Rad Immunity:} Timberwolves are immune to radiation due to their entirely magical nature, which in itself generates magical radiation, but in such small quantities that most creatures do not notice it.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Construct Orb (1 u., Thaumaturgy or Survival -20 to obtain)
		\item Green Herbs (1d4 u, Survival doubles u.)
		\item Blue Herbs (1d4 u., Survival doubles u.)
		\item Black Herbs (1d2 u., LCK doubles u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 4, \textbf{PER} 6, \textbf{END} 5, \textbf{CHA} 5, \textbf{INT} 3, \textbf{AGI} 8, \textbf{LCK} 3

\noindent
\textbf{Melee} 65, \textbf{Sneak} 80, \textbf{Unarmed} 50 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  

--------------------------------------

\noindent
\textbf{HP} 8, \textbf{DT} 1, \textbf{AP} 14, \textbf{Size} 0, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Poison 90\%, Radiation 60\%  %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none}
...
%		\textbf{Rad Resistant:} As Triggerblooms are radiation mutated plants, their high Rad Resistance allows them to bloom in highly radiated areas. Their Rad Resistance is 60.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Thorn (1d6 u., Survival doubles u.)
		\item Flower (1d4 u. Survival doubles u.)
		\item Green Herbs (1d6 u., Survival doubles u.)
		\item Red Herbs (1d4 u, Survival doubles u.)
		\item Pollen (1d6 u, Survival doubles u.)
	\end{compactitem}
...
\noindent
\textbf{Melee} 75, \textbf{Sneak} 80, \textbf{Unarmed} 60 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  

--------------------------------------

\noindent
\textbf{HP} 13, \textbf{DT} 2, \textbf{AP} 14, \textbf{Size} 0, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Poison 90\%,   %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none} Radiation 60\%
...
%		\textbf{Poison Resistant:} Triggerblooms are nearly immune to poisons due to their own potent poison eliminating most other poisons. Triggerblooms possess poison resistance of 90.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Irradiated Material (Irradiated Material, 2-4 u. Survival doubles u.)
		\item Thorn (1d6, Survival doubles u.)
		\item Blue Herbs (1d4 u., Survival doubles u.)
		\item White Herbs (1d4 u., Survival doubles u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 3, \textbf{PER} 7, \textbf{END} 4, \textbf{CHA} 2, \textbf{INT} 4, \textbf{AGI} 6, \textbf{LCK} 2

\noindent
\textbf{Explosives} 60, \textbf{Firearms} 60, \textbf{MEWs} 60, \textbf{Thaumaturgy} 40$^{\dag}$, %%\textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  
...
\noindent
\textbf{Potency} 5$^{\dag}$, \textbf{Strain} 10$^{\dag}$

\noindent
\textbf{Immunities}  Poison, Radiation, Taint %Fire,  \emph{none}, 

\noindent
\textbf{Resistances} \emph{none} %Poison 90\%,   %+2 END vs Burning- status effect %  ,  +2 END vs Cold exposure Cold +2 DT,  Radiation 60\%
...
--------------------------------------
	...
	\subsubsection*{Additional Combat Details:}
	\begin{verse}
		\textbf{Variable Weaponry:} Most Turrets are equipped with a single ranged weapon such as a machine gun, a laser rifle, or a grenade launcher. Weapon stats are dependent on the choice of a weapon from Wasteland Wares.
...
--------------------------------------
		...
		\textbf{\dag Turret Matrix:} Some turrets have a built-in matrix to enhance their usefulness. These turrets have access to following spells; Target, Remake, Failsafe and Shield. 
		
--------------------------------------
		
		\textbf{Combat Inhibitor:} Turrets are equipped with a combat inhibitor, that help them separate friends from woes. Combat inhibitor can be hacked with Science to various ends, such as shutting down the robot. Destroying the combat inhibitor turns the Turrets against anything around them.
		...
		\textbf{Tracking System:} Turrets track their targets, but crippling this part - a blinking light on their upper section - with a Called Shot with a penalty of -40 causes the turret to suffer a Minor Distraction until repaired. Turrets with \textit{Turret Matrix} can repair this condition with Remake-spell, costing 4 AP and 2 Strain.
...
%		\textbf{Rad Immunity:} Due to not being alive, radiation has no effect on Turrets.
	...
	\begin{compactitem}
		\item Scrap Metal, Common (1d4 u. Mechanics doubles u.)
		\item Scrap ArcanoTech, Common (1d2 u. Mechanics doubles u.)
		\item Scrap ArcanoTech, Rare (1 u.)
		\item Gun Component (1d4 u.)
		\item Junk (1d4 u.)
		\item Ammo (2d6 u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 3, \textbf{PER} 6, \textbf{END} 4, \textbf{CHA} 5, \textbf{INT} 3, \textbf{AGI} 6, \textbf{LCK} 5

\noindent
\textbf{Sneak} 40, \textbf{Unarmed} 60 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60, \textbf{Melee} 75, 

--------------------------------------

\noindent
\textbf{HP} 5, \textbf{DT} 0, \textbf{AP} 13, \textbf{Size} -3, \textbf{Karma} 0

%\noindent
%\textbf{Potency} 10, \textbf{Strain} 20

\noindent
\textbf{Immunities} Radiation, Taint % Poison,   Fire, \emph{none} , 

\noindent
\textbf{Resistances} Poison 70\%,   %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none} Radiation 60\%
...
\noindent
\textbf{STR} 9, \textbf{PER} 8, \textbf{END} 7, \textbf{CHA} 3, \textbf{INT} 5, \textbf{AGI} 4, \textbf{LCK} 4

\noindent
\textbf{Explosives} 70, \textbf{Firearms} 70, \textbf{MEWs} 70, \textbf{Thaumaturgy} 40$^{\dag}$, %%\textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60,  

--------------------------------------

\noindent
\textbf{HP} 16, \textbf{DT} 6, \textbf{AP} 12, \textbf{Size} 1, \textbf{Karma} 0
...
--------------------------------------
	...
	\subsubsection*{Additional Combat Details:}
	\begin{verse}
		\textbf{Minigun (7 AP):} Ultra-Sentinels are equipped with a powerful H\&K MGat-39 ``Mini Gun''. It acts like its Wasteland Wares -counterpart, but Ultra-Sentinel doesn't need to use AP to reload.
		
		\textbf{Missile Launcher (1 / 2 turns, 8 AP):} Ultra-Sentinel has a vast storage of small missiles it can launch with their mounted missile launcher. It acts like its Wasteland Wares -counterpart, with the exception that Ultra-Sentinel doesn't need to spend AP to reload.
		
		\textbf{Gauss Shotgun (5 AP):} In terms of close combat, Ultra-Sentinels are equipped with a "Gauss Shotgun" which acts as its Wasteland Wares -counterpart, with the exception that Ultra-Sentinel doesn't need to spend AP to reload.
...
--------------------------------------			
		...
		\textbf{Combat Inhibitor:} Ultra-Sentinels are equipped with a combat inhibitor, that help them separate friends from woes. Combat inhibitor can be hacked with Science to various ends, such as shutting down the robot. Destroying the combat inhibitor turns the Ultra-Sentinel against anything around them. However, Ultra-Sentinels are built with the Combat Inhibitor partially hidden, Called Shots targeting the Combat inhibitor suffers a -10 additional penalty.
...
%		\textbf{Rad Immunity:} Due to not being alive, radiation has no effect on Ultra-Sentinel.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Scrap Metal, Rare (1d6 u., Mechanics doubles u.)
		\item Scrap ArcanoTech, Rare (1d4 u., Mechanics doubles u.)
		\item Gun Component (2d4 u.)
		\item Magical Component (2d4 u.)
		\item Ammo (4d10 u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 3, \textbf{PER} 4, \textbf{END} 7, \textbf{CHA} 7, \textbf{INT} 2, \textbf{AGI} 8, \textbf{LCK} 5
...
\noindent
\textbf{HP} 6, \textbf{DT} 1, \textbf{AP} 14, \textbf{Size} -2, \textbf{Karma} 0

%\noindent
%\textbf{Potency} 10, \textbf{Strain} 20

\noindent
\textbf{Immunities} \emph{none}% Radiation, Taint  Poison,   Fire,  , 

\noindent
\textbf{Resistances} Poison 60\%, Radiation 40\%  %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none} 

\noindent
\textbf{Weaknesses} Fire (2x DMG) % %Cold (2x DMG),  % \emph{none}
...
--------------------------------------
		...
		\textbf{Camouflage:} Weedlings stands out as walking bushes. However, they hide well among vegetation, doubling their effective Sneak.
...
%		\textbf{Rad Resistant:} Weedlings are rather hardy against magical fallout, but large doses and prolonged exposure still proves fatal to them. Their Rad resistance is 40.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Berries (1d6, Survival doubles u.)
...
\noindent
\textbf{STR} 5, \textbf{PER} 5, \textbf{END} 7, \textbf{CHA} 2, \textbf{INT} 6, \textbf{AGI} 7, \textbf{LCK} 8

\noindent
\textbf{Sneak} 80, \textbf{Unarmed} 70 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60, \textbf{Melee} 75, 

--------------------------------------

\noindent
\textbf{HP} 14, \textbf{DT} 2, \textbf{AP} 13, \textbf{Size} 0, \textbf{Karma} -25
...
\noindent
\textbf{Resistances} \emph{none} %Poison 60\%, Radiation 40\%  %+2 END vs Burning- status effect  % ,  +2 END vs Cold exposure Cold +2 DT,  

\noindent
\textbf{Weaknesses} \emph{none} %Fire (2x DMG) % %Cold (2x DMG),   
...
%		\textbf{Rad Immunity:} Due to the dark, raw magic that empowers the Windigo, they are very well adapted to irradiated areas, even ground zero. They are immune to the effects of Radiation.
	...
	\subsubsection*{Creature drops:}
	Windigo Heart-gem (1 u. Gem worth 1000 caps)
	
	\subsection*{Description:}
	Windigos are malicious spirits, known to bring with them cold and snow. They tend to seek out ponies that share hatred and fights between each other, as it is their primary source of nutrition - and the more hatred they consume, the colder the surroundings of where Windigos roam turn.
	...
	Spotting a Windigo's presence may require some previous knowledge of the area. Sudden or unusual drop in temperature or slight snowfall in areas where there usually isn't may indicate towards the nefarious spirit's existence, especially if there's loud arguments or heavy fights in the area. 
...
\noindent
\textbf{STR} 5, \textbf{PER} 8, \textbf{END} 3, \textbf{CHA} 2, \textbf{INT} 1, \textbf{AGI} 8, \textbf{LCK} 4

\noindent
\textbf{Sneak} 40, \textbf{Unarmed} 40 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60, \textbf{Melee} 75, 

--------------------------------------

\noindent
\textbf{HP} 10, \textbf{DT} 0, \textbf{AP} 14, \textbf{Size} -1, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Poison 40\%, Radiation 50\%  %+2 END vs Burning- status effect  % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none}
...
--------------------------------------
		...
		\textbf{Quick Flier:} Wood-Rot Wasps are observative creatures, and due to this they get a +2 to their Initiative rolls.
...
%		\textbf{Rad Resistant:} Wood-Rot Wasp is an insect mutated by balefire fallout, gaining a decent resistance to the radiation. Wood-Rot Wasp's Rad Resistance is 50.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Spore Carrier Sap (1d4, Survival doubles u.)
		\item Pollen (1d8 u.)
		\item Stinger (1 u.)
	\end{compactitem}
...
\noindent
\textbf{STR} 8, \textbf{PER} 6, \textbf{END} 7, \textbf{CHA} 4, \textbf{INT} 3, \textbf{AGI} 4, \textbf{LCK} 4

\noindent
\textbf{Sneak} 60, \textbf{Unarmed} 70 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60, \textbf{Melee} 75, 

--------------------------------------

\noindent
\textbf{HP} 18, \textbf{DT} 3, \textbf{AP} 12, \textbf{Size} 1, \textbf{Karma} 0
...
\noindent
\textbf{Resistances} Poison 20\%, Radiation 50\%  %+2 END vs Burning- status effect  % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none}
...
%		\textbf{Rad Resistant:} As Balefire-mutated creatures, Yao Guai are reasonably equipped against radiation. Yao Guai's Rad Resistance is 50.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Yao Guai Meat (2d4 pieces, Survival doubles u.)
		\item Hide (1d4 pieces, Survival doubles u.)
		\item Vial of Yao Guai blood (3d4 u, Survival doubles u.)
		\item Yao Guai Crystals (1d4, Survival doubles u. Gem worth 200 caps)
	\end{compactitem}
	
	\subsection*{Ming Yao Guai}
...
\noindent
\textbf{STR} 10, \textbf{PER} 6, \textbf{END} 8, \textbf{CHA} 3, \textbf{INT} 2, \textbf{AGI} 4, \textbf{LCK} 4

\noindent
\textbf{Sneak} 60, \textbf{Unarmed} 75 %%\textbf{Barter} 70, \textbf{Diplomacy} 60, \textbf{Firearms} 45, \textbf{MEWs} 60, \textbf{Melee} 75, 

--------------------------------------

\noindent
\textbf{HP} 18, \textbf{DT} 4, \textbf{AP} 12, \textbf{Size} 2, \textbf{Karma} 0

%\noindent
%\textbf{Potency} 10, \textbf{Strain} 20

\noindent
\textbf{Immunities} Radiation %Poison,  Taint Fire, \emph{none}, 

\noindent
\textbf{Resistances} Poison 25\%   %+2 END vs Burning- status effect  % ,  +2 END vs Cold exposure Cold +2 DT, \emph{none} Radiation 50\%
...
--------------------------------------
		...
		\textbf{Noxious Odors (6 AP):} The Ming Yao Guai emits a foul stench, causing anyone within Large Splash template from it to suffer a poisoning with 2x50\% chance. When poisoned, the target suffers  a -2 to a random SPECIAL and no longer recovers Strain. Antivenom cures this effect.
		
--------------------------------------
		
		\textbf{Woodlands Stride:} Ming Yao Guai are capable of surprisingly agile movements for their size and weight, thus ignoring the +1 AP cost of Difficult Terrain.
...
%		\textbf{Rad Immunity:} Through further extended exposure to Radiation, Ghoulified Yao Guai have developed full immunity to Radiation.
	...
	\subsubsection*{Creature drops:}
	\begin{compactitem}
		\item Yao Guai Meat (Abomination Flesh Piece, 1d4 pieces, Survival doubles u.)
		\item Hide (1d4 pieces, Survival doubles u.)
		\item Vial of Yao Guai blood (3d4 u.)
		\item Yao Guai Crystals (1d4, Survival doubles u. Gem worth 200 caps)
	\end{compactitem}
...
\noindent
\textbf{STR} 5, \textbf{PER} 5, \textbf{END} 4, \textbf{CHA} 7, \textbf{INT} 7, \textbf{AGI} 7, \textbf{LCK} 6

\noindent
\textbf{Barter} 70, \textbf{Diplomacy} 40, \textbf{Firearms} 60, \textbf{Melee} 50, \textbf{MEWs} 60, \textbf{Sneak} 70, \textbf{Thaumaturgy} 60, \textbf{Unarmed} 60  

--------------------------------------

\noindent
\textbf{HP} 14, \textbf{DT} Varies, \textbf{AP} 13, \textbf{Size} 0 \textbf{Karma} Varies
...
\noindent
\textbf{Resistances} Poison 20\%, Radiation 5\% %+2 END vs Burning- status effect % % ,  +2 END vs Cold exposure Cold +2 DT,   % \emph{none}
...
--------------------------------------
	...
	\subsubsection*{Additional Combat Details:}
	\begin{verse}
		\textbf{Wasteland Weaponry:} Zebras can carry just about any weapon and armor imaginable. Especially popular are Silaha-brand MEWs, which are of zebra origin.
		
--------------------------------------
		
		\textbf{Shamanism:} Some zebras can use Spirits in battle, both Pact and Possession Spirits are popular.
		
		\textbf{Alchemical Interests:} Zebras know how to brew potions and poisons and do not shy from using them.
		
--------------------------------------
		
		\textbf{Abomination Hunter:} Due to their high-caliber weaponry and armor, most zebras are well-equipped to fight even the most horrid things the Wasteland has to offer. They gain a +10 to Combat skills when targeting Abominations, including sane Ghouls.
		
		\textbf{Zebra Language:} Zebra speak their own native language, often allowing them to communicate on the battlefield without their enemy catching on. Characters that understand Zebra language can interpret them, however.
		
		\textbf{Organized:} Zebra tribals have hierarchy of leadership. They strike as units and groups of various sizes, usually under at least one spokesperson. Eliminating such spokesperson often leaves rest of the  group at disarray and demoralized, giving them a -5 to all skill actions.
...
%		\textbf{Rad Resistant:} Zebra are just as weak to the magical radiation as their pony counterparts, giving them 5 Rad Resistance. However, they may equip armor to shield themselves from this danger.
	...
	{
	%	\rowcolors{1}{gray!30}{gray!10}
		\begin{tblr} %to 160mm{| X[l,1] | X[l,4] |}
			[
			caption={Critters by Category},
			entry=none,
			label=none
			]
			{				
			...
			Abomination              & Alicorns, Necrosprite, Brahmin, Chimera, Feral Mongrel, Ghouls, Ghost, Hellhound, Hospital Horror, Myling, Possessed Shamans, Radstag, Shade, Spore Carrier, Windigo, Ming Yao Guai  \\
			...
			Animal, Non-Mutated      & Cockatrice, Hydra, Jackalopes, Manticore, Protochimera, Puckwudgie, Quarray Eel, Star-Spawn, Timberwolf      \\
			...
			Sentient                 & Alicorns, Changeling, Dragon, Enclave, Hellhound, Mercenary, Possessed Shaman, Protochimera, Raider, Slaver, Steel Ranger, Thug, Zebra Tribal \\ \hline
		\end{tblr}
